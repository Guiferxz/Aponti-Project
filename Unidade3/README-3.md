# Unidade 3 — Análise de Dados da PRF com SQL

## 📌 Sobre a atividade

A unidade 03 tem como objetivo aplicar conceitos de **Banco de Dados e SQL** sobre a base de acidentes da **Polícia Rodoviária Federal (PRF) — DATATRAN 2025**.
